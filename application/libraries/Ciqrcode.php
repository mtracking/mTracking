...
class Ciqrcode
{
    ...
    function __construct($config = array()) {
        ...
        include APPPATH."/third_party/qr_code/qrconst.php";
        include APPPATH."/third_party/qr_code/qrtools.php";
        include APPPATH."/third_party/qr_code/qrspec.php";
        include APPPATH."/third_party/qr_code/qrimage.php";
        include APPPATH."/third_party/qr_code/qrinput.php";
        include APPPATH."/third_party/qr_code/qrbitstream.php";
        include APPPATH."/third_party/qr_code/qrsplit.php";
        include APPPATH."/third_party/qr_code/qrrscode.php";
        include APPPATH."/third_party/qr_code/qrmask.php";
        include APPPATH."/third_party/qr_code/qrencode.php";
